...
public class SequenceTableMappingTests {
     ...
     *   - GenerationType.IDENTIFY: 기본 키 생성을 데이터베이스에 위임(MySQL 또는 MariaDB의 auto_increment)
     *   - GenerationType.SEQUENCE: 데이터베이스 시퀀스 객체 사용(ORACLE의 SEQUENCE)
     *   - GenerationType.TABLE: 키 생성 태이블 사용
     *   - GenerationType.AUTO: 자동 선택{MySQL의 IDENTIFY 또는 ORACLE이면 SEQUENCE)
     * */
...
//        member2.setMemberNo(1);
        ...
        member2.setPhone("010-2343-5278");
